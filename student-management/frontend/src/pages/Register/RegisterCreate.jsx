                    ...
                    <div className="row">
                        <div className="col-md-5">
                                ...
                                <select className="form-control" name="student_id" id="student_id"
                                    ...
                                    <option value=''>Vui lòng chọn sinh viên</option>
                                    {
                                        students.map((student, indexStudent) => (
                                            <option key={indexStudent} value={student._id}>{student._id} - {student.name}</option>
                                        ))
                                    }
                                </select>
                                ...
                                >
                                    <option value=''>Vui lòng chọn môn học</option>
                                    {
                                        subjects.map((subject, indexSubject) => (
                                            <option key={indexSubject} value={subject._id}>{subject._id} - {subject.name}</option>
                                        ))
                                    }
                                </select>
                            ...
                            <div className="form-group">
                                ...
                                <button onClick={() => navigate("/register/list")} className="btn btn-warning ml-2" type="button">Quay về</button>
                            </div>
                        </div>
                    </div>
                </div>
